...
CREATE TABLE IF NOT EXISTS article (
  ...
  type               TINYINT NOT NULL DEFAULT 1 COMMENT '1-技术分析，2-关于生活，3-关于我',
  status             TINYINT NOT NULL DEFAULT 1 COMMENT '是否启用，true－启用，false－停用，默认为启用',
...
CREATE TABLE IF NOT EXISTS comment (
  ...
  username           VARCHAR(128) NOT NULL NULL DEFAULT '' COMMENT '用户名',
  email              VARCHAR(128) NOT NULL NULL DEFAULT '' COMMENT 'email',
  location           VARCHAR(128) NOT NULL NULL DEFAULT '' COMMENT 'ip归属地',
  comment            VARCHAR(255) NOT NULL NULL DEFAULT '' COMMENT '评论内容',
  status             TINYINT NOT NULL DEFAULT 1 COMMENT '是否启用，true－启用，false－停用，默认为启用',
  create_date BIGINT NOT NULL COMMENT '创建时间',
  update_date BIGINT NOT NULL COMMENT '更新时间',
  PRIMARY KEY(id)
